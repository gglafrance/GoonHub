...
func TestValidatePoolConfig(t *testing.T) {
	tests := []struct {
		...
		{"all valid", PoolConfigInput{MetadataWorkers: 5, ThumbnailWorkers: 5, SpritesWorkers: 5}, false},
		{"minimum all", PoolConfigInput{MetadataWorkers: 1, ThumbnailWorkers: 1, SpritesWorkers: 1}, false},
		{"maximum all", PoolConfigInput{MetadataWorkers: 10, ThumbnailWorkers: 10, SpritesWorkers: 10}, false},
		{"metadata too low", PoolConfigInput{MetadataWorkers: 0, ThumbnailWorkers: 5, SpritesWorkers: 5}, true},
		{"thumbnail too high", PoolConfigInput{MetadataWorkers: 5, ThumbnailWorkers: 11, SpritesWorkers: 5}, true},
		{"sprites invalid", PoolConfigInput{MetadataWorkers: 5, ThumbnailWorkers: 5, SpritesWorkers: -1}, true},
	}
