...
export const useApi = () => {
    ...
    return {
        ...
        fetchAllSearchSceneIDs: scenes.fetchAllSearchSceneIDs,
        ...
        fetchAllActorSceneIDs: actors.fetchAllActorSceneIDs,
        ...
        fetchAllStudioSceneIDs: studios.fetchAllStudioSceneIDs,
