    ...
    switch (props.field) {
        ...
        case 'views':
            return props.scene.view_count != null
                ? {
                      icon: 'heroicons:eye',
                      text: String(props.scene.view_count),
                      class: 'bg-void/90',
                  }
                : null;
        case 'jizz_count':
        ...
        case 'watched':
            return props.completed
                ? {
                      icon: null,
                      text: 'Watched',
                      class: 'bg-emerald-500/90 text-white !text-[9px] font-semibold',
                  }
                : null;
        default:
            return null;
...
<template>
    ...
    <SceneCardTagsShort v-if="field === 'tags' && scene.tags?.length" :tags="scene.tags" badge />
    ...
    <div
        v-else-if="badge"
        class="z-20 flex items-center gap-0.5 rounded px-1.5 py-0.5 font-mono text-[10px]
